...
# Link to historical data page (moved to separate page for better performance)
st.info("📊 **View Historical Play-by-Play Data** - Use the sidebar navigation to access the **Historical Data** page with 196k+ rows of NFL play-by-play data from 2020-2024 seasons.")
