...
features = [
    # Pregame features only
    'spread_line', 'total', 'away_moneyline', 'home_moneyline', 'away_spread_odds', 'home_spread_odds', 'total_line',
...
model_moneyline = CalibratedClassifierCV(XGBClassifier(eval_metric='logloss'), method='isotonic', cv=3)
